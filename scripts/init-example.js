...
const cmdExample = 'please execute command like \'npm run init:example hippy-react-demo\' or \'npm run init:example hippy-vue-demo\' or \'npm run init:example hippy-vue-next-simple-demo\'';
